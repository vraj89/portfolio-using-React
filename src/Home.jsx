...
export const Home = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative pt-16 md:pt-0">
      <div className="text-center z-10 px-4 max-w-4xl mx-auto" style={{ marginTop: '4rem' }}>
        <div className="mb-4 text-blue-400 font-semibold text-sm md:text-base tracking-widest uppercase">
