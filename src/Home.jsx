    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative">
      <div className="text-center z-10 px-4">
        ...
        <p className="text-gray-400 text-lg md:text-2xl max-w-2xl mx-auto mb-8">
          I'm a React Developer with a passion for creating interactive and
          responsive web applications using React.js. And ready to learn new technologies
          and take on challenges in the world of web development.
        </p>
